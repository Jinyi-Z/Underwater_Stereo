...
def Gwc_dicriminator(d):
    return Discriminator_3D_2(d)

class Discriminator_3D_2(nn.Module):

    def __init__(self,max_disp, num_classes=2, init_width=32, input_channels=1):
        self.inplanes = init_width
        super(Discriminator_3D_2, self).__init__()
        self.maxdisp = max_disp
        self.preg = GwcNet(self.maxdisp,use_concat_volume=True)
